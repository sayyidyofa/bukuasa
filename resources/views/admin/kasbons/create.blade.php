...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.kasbon.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.kasbons.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('cut_start') ? 'is-invalid' : '' }}" type="text" name="cut_start" id="cut_start" value="{{ old('cut_start') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('cut_end') ? 'is-invalid' : '' }}" type="text" name="cut_end" id="cut_end" value="{{ old('cut_end') }}" required>
