    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.overtimes.update", [$overtime->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dept') ? 'is-invalid' : '' }}" type="text" name="dept" id="dept" value="{{ old('dept', $overtime->dept) }}" required>
                @if($errors->has('dept'))
                    <div class="invalid-feedback">
                        {{ $errors->first('dept') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date') ? 'is-invalid' : '' }}" type="text" name="date" id="date" value="{{ old('date', $overtime->date) }}" required>
                @if($errors->has('date'))
                    <div class="invalid-feedback">
                        {{ $errors->first('date') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('start_hour') ? 'is-invalid' : '' }}" type="text" name="start_hour" id="start_hour" value="{{ old('start_hour', $overtime->start_hour) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('end_hour') ? 'is-invalid' : '' }}" type="text" name="end_hour" id="end_hour" value="{{ old('end_hour', $overtime->end_hour) }}" required>
