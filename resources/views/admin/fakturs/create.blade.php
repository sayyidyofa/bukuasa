    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.fakturs.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('diskon_markup') ? 'is-invalid' : '' }}" type="number" name="diskon_markup" id="diskon_markup" value="{{ old('diskon_markup', '') }}" step="0.01" required>
