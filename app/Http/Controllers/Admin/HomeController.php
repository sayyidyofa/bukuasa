...
class HomeController
{
    ...
    {
        $settings1 = [
            'chart_title'           => 'Uang Masuk Bulan Ini',
        ...
        $settings2 = [
            'chart_title'           => 'Hasil Las Bulan Ini',
            'chart_type'            => 'number_block',
            'report_type'           => 'group_by_date',
            'model'                 => 'App\Models\Welding',
            'group_by_field'        => 'date',
            'group_by_period'       => 'month',
            'aggregate_function'    => 'sum',
            'aggregate_field'       => 'weight_kg',
            'filter_field'          => 'created_at',
            'filter_period'         => 'month',
        ...
        $settings3 = [
            'chart_title'           => 'Barang Keluar Bulan Ini',
            'chart_type'            => 'number_block',
            'report_type'           => 'group_by_date',
        ...
        $settings4 = [
            'chart_title'           => 'Pengiriman Minggu Ini',
            'chart_type'            => 'number_block',
            'report_type'           => 'group_by_date',
